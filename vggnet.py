...
Original file is located at
    https://colab.research.google.com/drive/1unVp6DV9f2G5gwkG3HuclV7EAtw_cYp5
"""
...
#!ls drive/MyDrive/transferLearning/kaggle/fruits-360/Training

#!cd drive/MyDrive/transferLearning
...
#!cp -r drive/MyDrive/transferLearning/kaggle/fruits-360/Training/Banana ./fruitz/train/
#!cp -r drive/MyDrive/transferLearning/kaggle/fruits-360/Training/Blueberry ./fruitz/train/
#!cp -r drive/MyDrive/transferLearning/kaggle/fruits-360/Training/Lemon ./fruitz/train/


# copying the #of classes for test
#!cp -r drive/MyDrive/transferLearning/kaggle/fruits-360/Test/Banana ./fruitz/test/
#!cp -r drive/MyDrive/transferLearning/kaggle/fruits-360/Test/Blueberry ./fruitz/test/
#!cp -r drive/MyDrive/transferLearning/kaggle/fruits-360/Test/Lemon ./fruitz/test/

!ls ./fruitz/train

train_path='./fruitz/train/'
val_path='./fruitz/test/'
...
# using the glob lib to get all the files
